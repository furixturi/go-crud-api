...
func TestGetNonExistentProduct(t *testing.T) {
	...
	if m["error"] != "Product not found" {
		t.Errorf("Expected the \"error\" key of the response to be set to \"Product not found\". Got \"%s\".\n", m["error"])
	}
}
...
func TestCreateProduct(t *testing.T) {
	...
	// JSON unmarsharling converts numbers to floats when the target is a map[string]interface{}
	if m["id"] != 1.0 {
